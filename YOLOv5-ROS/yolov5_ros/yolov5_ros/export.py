...
#install_type = 'non_merge_install'
install_type = 'merge_install'
...
@torch.no_grad()
def run(
        data=os.path.join(FILE.parents[i], 'yolov5_ros', 'share', 'yolov5_ros', 'data', 'coco128.yaml'),  # 'dataset.yaml path'
        weights=os.path.join(FILE.parents[i], 'yolov5_ros', 'share', 'yolov5_ros', 'config', 'yolov5s.pt'), #ROOT / 'yolov5s.pt',  # weights path
